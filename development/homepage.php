<?php @include "page-components/page-start.php" ?>
	...
	<section class="box-intro">
		...
		<!-- carousel -->
		<ul class="list-intro" id="js-intro-carousel">
			<li class="list-intro__item">
				<article class="list-intro__item__in">
					<div class="container">
						<header class="list-intro__item__content">
							<h2 class="list-intro__item__title">
								Najdeme pro vás nový domov 
							</h2>

							<a href="#" class="button">
								Najít svůj nový domov
							</a>
						</header>
					</div>
					<img data-lazy="assets/images/web/intro/1.jpg" alt="" onload="imageToParentsBackground(this, '.list-intro__item__in')">
				</article>
			</li>
		...
		<div class="container">
			...
			<ul class="list-advantages">
				<li class="list-advantages__item">
					<article class="list-advantages__item__in">
						<figure class="list-advantages__item__image">
							<img src="assets/images/web/advantages/1.png" alt="">
						</figure>

						<h3 class="list-advantages__item__title">
							Stovky nemovitostí
						</h3>

						<div class="list-advantages__item__desc">
							<p>
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse aliquam condimentum tortor, eget luctus velit.
							</p>
						</div>
					</article>
				</li>
				...
				<li class="list-advantages__item">
					<article class="list-advantages__item__in">
						<figure class="list-advantages__item__image">
							<img src="assets/images/web/advantages/2.png" alt="">
						</figure>
				...
				<li class="list-advantages__item">
					<article class="list-advantages__item__in">
						<figure class="list-advantages__item__image">
							<img src="assets/images/web/advantages/3.png" alt="">
						</figure>
	...
	<section class="wrap-section">
		<div class="container">
			<header class="wrap-section__header">
				<h3 class="wrap-section__header__subtitle">
					Vybrané nemovitosti
				</h3>
			</header>
	...
	<section class="wrap-section">
		<div class="container">
			<header class="wrap-section__header">
				<h2 class="wrap-section__header__subtitle">
					Města a regiony
				</h2>
			</header>

			<div class="in-regions-towns">
				<div class="columns">
					<div class="columns__item columns__item--33">
						<h3 class="in-regions-towns__title">
							Praha
						</h3>
					...
					<div class="columns__item columns__item--34">
						<h3 class="in-regions-towns__title">
							Jihočeský
						</h3>
